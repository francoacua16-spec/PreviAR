  ...
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center px-6 text-center">
      <div className="glass w-full max-w-sm rounded-3xl p-8 animate-fade-up">
        <PinLogo className="mx-auto mb-5 h-14 w-14 opacity-50 grayscale" />
        ...
        <Link
          href="/"
          className="mt-6 inline-flex h-11 items-center gap-2 rounded-full bg-primary px-6 text-sm font-semibold text-primary-foreground shadow-neon-pink"
        >
