...
export const CITIES: CityDef[] = [
  ...
  },
  {
    ...
    zones: [
      ...
      { key: 'melipal', label: 'Melipal', lat: -41.1275, lng: -71.3672 },
      { key: 'las-victorias', label: 'Las Victorias', lat: -41.1467, lng: -71.3472 },
      { key: 'este', label: 'Este', lat: -41.135, lng: -71.25 },
      { key: 'km8', label: 'Km 8', lat: -41.1233, lng: -71.4017 },
      { key: 'circuito-chico', label: 'Circuito Chico', lat: -41.0872, lng: -71.5461 },
      { key: 'playa-bonita', label: 'Playa Bonita', lat: -41.1213, lng: -71.4075 },
      { key: 'colonia-suiza', label: 'Colonia Suiza', lat: -41.1053, lng: -71.5453 },
      { key: 'villa-los-coihues', label: 'Villa Los Coihues', lat: -41.15, lng: -71.4 },
      { key: 'lago-gutierrez', label: 'Lago Gutiérrez', lat: -41.1836, lng: -71.3839 },
      { key: 'cerro-otto', label: 'Cerro Otto', lat: -41.1394, lng: -71.3661 },
      { key: 'cerro-catedral', label: 'Cerro Catedral', lat: -41.1656, lng: -71.4425 },
      { key: 'pinar-de-arelauquen', label: 'Pinar de Arelauquen', lat: -41.175, lng: -71.385 },
      { key: 'bustillo-km12', label: 'Bustillo Km 12', lat: -41.1178, lng: -71.4436 },
      { key: 'bustillo-km18', label: 'Bustillo Km 18', lat: -41.105, lng: -71.5017 },
      { key: 'virgen-de-las-nieves', label: 'Virgen de las Nieves', lat: -41.1444, lng: -71.3 },
      { key: 'barrio-belgrano', label: 'Belgrano', lat: -41.1417, lng: -71.3117 },
